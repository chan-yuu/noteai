...
async def stream_chat_response(
    session_id: str, message: str, context: Dict[str, Any], model_override: Optional[str] = None
    ...
    try:
        ...
        # Execute chat graph with streaming - use astream_events for granular token streaming
