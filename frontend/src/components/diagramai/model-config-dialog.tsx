...
import type { UseModelConfigReturn } from "@/lib/hooks/diagramai/use-model-config"
import { formatMessage } from "@/lib/diagramai/i18n/utils"
import type { ProviderConfig, ProviderName } from "@/lib/diagramai/types/model-config"
import { PROVIDER_INFO, SUGGESTED_MODELS } from "@/lib/diagramai/types/model-config"
import { cn } from "@/lib/diagramai/utils"
    ...
    const handleValidate = useCallback(async () => {
        ...
        for (let i = 0; i < selectedProvider.models.length; i++) {
            ...
            try {
                ...
                const response = await fetch("/api/diagramai/validate-model", {
                    method: "POST",
