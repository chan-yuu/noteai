...
import {
    ...
    ReasoningContent,
    ReasoningTrigger,
} from "@/components/diagramai/ai-elements/reasoning"
import { ChatLobby } from "@/components/diagramai/chat/ChatLobby"
import { ToolCallCard } from "@/components/diagramai/chat/ToolCallCard"
import type { DiagramOperation, ToolPartLike } from "@/components/diagramai/chat/types"
import type { ValidationState } from "@/components/diagramai/chat/ValidationCard"
import { ValidationCard } from "@/components/diagramai/chat/ValidationCard"
...
export function ChatMessageDisplay({
    ...
    const submitFeedback = async (messageId: string, value: "good" | "bad") => {
        ...
        try {
            await fetch(getApiEndpoint("/api/diagramai/log-feedback"), {
                method: "POST",
