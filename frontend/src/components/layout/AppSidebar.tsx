...
const getNavigation = (t: TranslationKeys) => [
  ...
  },
  {
    ...
    items: [
      { name: t.navigation.diagramai, href: '/diagramai', icon: Workflow },
    ],
  },
  {
...
export function AppSidebar() {
  ...
  const { openSourceDialog, openNotebookDialog, openDiagramDialog } = useCreateDialogs()
          ...
          {isCollapsed ? (
            ...
            <>
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-serif font-semibold text-sidebar-foreground tracking-tight">
                  {t.common.appName}
                </span>
              </div>
              <Button
            ...
            <div key={section.title}>
              ...
              <div className="space-y-1">
                ...
                {section.items.map((item) => {
                  ...
                  const isAction = item.href === '/diagramai'

                  const handleClick = (e: React.MouseEvent) => {
                    if (item.href === '/diagramai') {
                      e.preventDefault()
                      openDiagramDialog()
                    }
                  }
