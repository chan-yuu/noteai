...
import type { DiagramOperation } from "@/components/diagramai/chat/types"
import type {
    ValidationState,
    ValidationStatus,
} from "@/components/diagramai/chat/ValidationCard"
import type { ValidationResult } from "@/lib/diagramai/diagram-validator"
import { formatValidationFeedback } from "@/lib/diagramai/diagram-validator"
import { isMxCellXmlComplete, wrapWithMxFile } from "@/lib/diagramai/utils"
...
\`\`\``,
    ...
    const handleEditDiagram = async (
        ...
        try {
            ...
            const { applyDiagramOperations } = await import("@/lib/diagramai/utils")
