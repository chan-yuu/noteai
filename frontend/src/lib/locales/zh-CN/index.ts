export const zhCN = {
  ...
  podcast: {
    title: "AI 播客工作室",
    description: "使用 AI 将任何主题转化为引人入胜的多人播客。",
    topicLabel: "主题或内容",
    topicPlaceholder: "这个播客关于什么？（例如：'AI 的未来'，或粘贴笔记本摘要）",
    tip: "由 Qwen-Plus (脚本) 和 CosyVoice-v3 (音频) 提供支持。",
    generate: "生成播客",
    generating: "制作中...",
    library: "媒体库",
    episodes: "集",
    noEpisodes: "暂无播客",
    startCreating: "从左侧面板开始您的第一次录制。",
    download: "下载 MP3",
    status: {
      pending: "排队中",
      generating_script: "正在编写脚本...",
      generating_audio: "正在录制音频...",
      completed: "已完成",
      failed: "失败",
    },
    context: {
      label: "上下文（知识库）",
      placeholder: "选择笔记本或来源...",
      empty: "未找到项目。",
    },
  },
  video: {
    title: "AI 视频工作室",
    description: "使用最先进的 Wan2.2 模型制作令人惊叹的视频。",
    promptLabel: "提示词",
    promptPlaceholder: "详细描述您想要生成的视频...",
    tip: "提示：描述光线、相机运动（例如“缓慢平移”）和艺术风格。",
    sourceImage: "源图片",
