export const enUS = {
  ...
  podcast: {
    ...
    description: "Turn any topic into an engaging multi-speaker podcast using AI.",
    topicLabel: "Topic or Content",
    topicPlaceholder: "What should this podcast be about? (e.g., 'The future of AI', or paste a summary of a notebook)",
    tip: "Powered by Qwen-Plus (Script) and CosyVoice-v3 (Audio).",
    generate: "Generate Podcast",
    generating: "Producing...",
    library: "Library",
    episodes: "episodes",
    noEpisodes: "No podcasts created yet",
    startCreating: "Start your first recording from the panel on the left.",
    ...
    context: {
      label: "Context (Knowledge Base)",
      placeholder: "Select notebooks or sources...",
      empty: "No items found.",
    },
  },
  video: {
    title: "AI Video Studio",
    description: "Create stunning videos using State-of-the-Art Wan2.2 models.",
    promptLabel: "Prompt",
    promptPlaceholder: "Describe the video you want to generate in detail...",
    tip: "Tip: Describe lighting, camera motion (e.g., \"slow pan\"), and artistic style.",
    ...
    startCreating: "Start your first creation from the panel on the left.",
